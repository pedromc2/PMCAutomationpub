...
WebUI.callTestCase(findTestCase('Askblue_Training/Add_to_Cart_Backpack'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Swag Labs/a_Swag Labs_shopping_cart_link'), '')
