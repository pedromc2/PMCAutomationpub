...
for (int i = 0; i < removeList.size(); i++) {
    ...
    // Verifica se é o número esperado OU está vazio (quando removemos tudo)
    int expectedCount = removeList.size() - i - 1
    
	if (expectedCount == 0) {
        WebUI.verifyMatch(cartIconText, "", false) // Permite que o ícone esteja vazio
    } else {
