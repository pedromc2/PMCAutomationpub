...
WebUI.callTestCase(findTestCase('Askblue_Training/Add_to_Cart/Add_to_Cart_Todos'), [:], FailureHandling.STOP_ON_FAILURE)
...
List<WebElement> checkoutItemNameList = WebUI.findWebElements(findTestObject('Object Repository/Page_Swag Labs/checkout_item_price'), 10)
List<WebElement> checkoutItemPriceList = WebUI.findWebElements(findTestObject('Object Repository/Page_Swag Labs/checkout_item_price'), 10)
