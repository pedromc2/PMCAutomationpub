...
//System.out.println(listaAddToCart)
Random rand = new Random()

//System.out.println(rand)
String addToCart_Aleatorio = listaAddToCart.get(rand.nextInt(listaAddToCart.size()))

//System.out.println(addToCart_Aleatorio)
WebUI.click(findTestObject(addToCart_Aleatorio))
